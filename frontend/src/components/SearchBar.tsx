...
export const SearchBar = () => {
  ...
  return (
        <form onSubmit={handlesubmit}  className="grid items-center grid-cols-2 gap-4 p-3 -mt-8 bg-orange-400 rounded shadow-md lg:grid-cols-3 2xl:grid-cols-5">
            <div className="flex flex-row items-center flex-1 p-2 bg-white">
                <MdTravelExplore size={25} className="mr-2"/>
                <input type="text" placeholder="Where are you going" className="w-full text-md focus:outline-none" value={destination}
